    ...
    def _handle_call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        # Route to search
            ...
            if search_tool:
                ...
                from src.agent.entities import valid_entities_dict
                mock_entities = []
                    ...
                    if isinstance(val_list, list):
                        for val in val_list:
                            ...
                            if field == "customer_id":
                                entity_class = valid_entities_dict.get("Customer")
                            elif field == "owner_id":
                                entity_class = valid_entities_dict.get("Employee")
                            elif field == "id":
                                entity_class = self.entity_class
                            
                            if entity_class:
                                mock_entities.append(entity_class.model_construct(id=val))
